...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'sistema_persona', (
            ...
            ('carnet_conadis', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
    ...
    models = {
        ...
        u'sistema.persona': {
            ...
            'carnet_conadis': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
