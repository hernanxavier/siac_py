/**
 * @class IAEN.desktop.WindowManager
...
Ext.define("IAEN.desktop.WindowManager",{
	extend				: "Ext.Component",
	requires			: [
		"Ext.util.MixedCollection",
		"IAEN.desktop.LoadingModule",
		"IAEN.desktop.Window"
	],
	...
	activeWindowCls		: 'IAEN-desktop-active-win',
    inactiveWindowCls	: 'IAEN-desktop-inactive-win',
	 ...
	 * @return {IAEN.desktop.Window} Return a window
	 */
	createWindow	: function(app){
        ...
        win = Ext.create("IAEN.desktop.Window",cfg);
	...
	updateActiveWindow: function () {
        ...
        // prepends the active app window's title to the IAEN desktop window title, e.g.: [app title] - desktop title
